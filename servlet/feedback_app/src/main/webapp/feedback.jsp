...
<html lang="en">
  ...
  <body>
   <%@ include file="header.jsp"%>
    ...
    <form action="<%= application.getContextPath()%>/feedback" method="post" class="">
      <div class="mb-3">
      ...
      <div class="mb-3">
              ...
              <textarea rows="10" placeholder="Enter here.." name="feedback_msg" class="form-control" cols=""></textarea>
            </div>
